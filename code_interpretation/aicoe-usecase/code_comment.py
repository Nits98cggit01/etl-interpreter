...
def generate_comments(code):
    ...
    response = openai.Completion.create(
            ...
            prompt=f'''Add comments to the {programming_language} code wherever required. 
                    The comments should be present only top of the input code snippet and not inside the function block to maintain good spacing and better readability.
                    Make sure that the complete input code snippet is displayed along with the added comments!! 
                      :
                    \n{code}
                    ''',
            max_tokens=1024, 
